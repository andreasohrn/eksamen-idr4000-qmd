...
poolsample1 <- read_excel("data/data-part2/poolsample1.xlsx")
poolsample2 <- read_excel("data/data-part2/poolsample2.xlsx")
mhc <- read_excel("data/data-part2/mhc1.xlsx")
cv <- read_excel("data/data-part2/mhc1.xlsx")
...
ct = read_excel("data/data-part2/mhc1.xlsx")%>%
    select(27,28,29) %>% 
  drop_na("...27")
